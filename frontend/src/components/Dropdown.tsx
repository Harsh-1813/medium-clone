...
export const Dropdown = () => {
    ...
    return <div className="relative inline-block max-w-screen mb-2" ref={dropdownRef}>
        ...
        {isOpen && (
            <ul
                ...
                className="absolute z-10 min-w-[180px] right-0 overflow-auto rounded-lg border border-slate-200 bg-white p-1.5 shadow-lg shadow-sm mt-2 focus:outline-none"
            >
                <li
                    role="menuitem"
